...
print(f"ALL_SYMPTOMS length: {len(ALL_SYMPTOMS)}")
...
if os.path.exists(model_path):
    ...
    # Try to see if there are any identifiers for the features
    # (Scikit-learn random forest doesn't store feature names by default unless fit on a DataFrame)
